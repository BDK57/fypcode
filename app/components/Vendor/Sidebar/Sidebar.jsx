...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const [addHallToggle, setaddHallToggle] = useState(true)

  const [profileOption, setprofileOption] = useState(false)
  const handleProfileMenu =()=>{
    setprofileOption(true)
    setaddHallToggle(false)
  }
  const addHallHandler=()=>{
    setprofileOption(false)
    setaddHallToggle(true)
  }
                      ...
                      <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                        <li>
                          <span
                            ...
                            className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-mainColor cursor-pointer ${pathname ===
                              "/" && "text-white"} `}
                              onClick={addHallHandler}
                          >
                            Add Hall
                          </span>
                        </li>
